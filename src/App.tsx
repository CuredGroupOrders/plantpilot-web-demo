...
const LS_KEY_SUBMITTED = "smf.last.intake.submitted.v1";
...
function computePhysicsIrrGate(args: {
  irrPlan: any | null;
  p1Events?: number;
  p1MlPerEvent?: number;
  p2Events?: number;
...
/* ================= storage helpers ================= */
function getLastIntake(): Intake | null {
  try {
...
function setLastIntake(i: Intake | null) {
  try {
    i
...
function getLastSubmittedIntake(): Intake | null {
  try {
...
export default function App() {
  const [viewMode, setViewMode] = useState<"intake" | "rnd">("intake");
